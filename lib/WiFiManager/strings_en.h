...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''><br/><label for='p'>Password</label><input id='p' name='p' maxlength='64' type='password' placeholder=''>";
...
// zarko.runjevac 15.5.2019 added 2 pages id and scan
const char R_id[]                 PROGMEM = "/id";
const char R_scan[]               PROGMEM = "/scan";
